...
if (!$err_profile_setting) {
  ...
  echo "<tr><td>";
  echo "<font color=green><b>Успех:</b> Профиль изменен!<br /></font>";
  foreach ($success_profile_setting as $key => $value) {
    echo $success_profile_setting[] = $value;
    echo "<br />";
  }
  echo '
    <p align=center>
  ...
  echo "<tr><td><font color=red><b>Ошибка:</b> Профиль не изменен!<br /></font>";
  foreach ($err_profile_setting as $key => $value) {
    echo $err_profile_setting[] = $value;
    echo "<br />";
  }
  echo '
    <p align=center>
