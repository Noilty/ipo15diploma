...
require '../includes/html/profile/accordion.php';
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Профиль пользователя</h2>
                ...
                <div class="row">
                    ...
                    <!-- content -->
                    <!-- ============================================================== -->
                    <?php require '../includes/html/profile/table.php'; ?>
                    <?php echo $PROFILE_TABLE_INFO_USER; ?>
                    <!-- ============================================================== -->
                    <!-- end content -->
                    <!-- ============================================================== -->
                    <!-- ============================================================== -->
