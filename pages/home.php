...
require '../includes/html/home/table.php';
      ...
      <div class="nav-left-sidebar sidebar-dark">
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Главная страница</h2>
                ...
                <div class="card">
                    <div class="alert alert-light" role="alert" style="text-align-last: center;margin-bottom: 0em;">
